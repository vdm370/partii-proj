#!/bin/bash
# g++ -std=c++14 -o exec/exact/bb_op cpp/exact/branch_and_bound_op.cpp cpp/heuristic/improvement/3opt_random.cpp cpp/heuristic/greedy2.cpp cpp/helpers/solution.cpp cpp/helpers/graph_dist.cpp -I headers/ && echo 'op branch and bound successfully compiled' &&
